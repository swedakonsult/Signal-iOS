...
-(PhoneNumberDirectoryFilter*) tryGetSavedPhoneNumberDirectory {
    ...
    NSData* data = [[SignalCacheManager sharedInstance] tryRetrieveBloomFilter];
...
-(void) setSavedPhoneNumberDirectory:(PhoneNumberDirectoryFilter*)phoneNumberDirectoryFilter {
    [[SignalCacheManager sharedInstance] storeBloomfilter:nil];
    ...
    [[SignalCacheManager sharedInstance] storeBloomfilter:data];
